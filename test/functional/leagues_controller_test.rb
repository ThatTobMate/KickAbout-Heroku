...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { gd: @league.gd, location: @league.location, name: @league.name, points: @league.points, position: @league.position }
    end
  ...
  test "should update league" do
    put :update, id: @league, league: { gd: @league.gd, location: @league.location, name: @league.name, points: @league.points, position: @league.position }
    assert_redirected_to league_path(assigns(:league))
  end
